...
class Radio:
    """ Define and contain radio vars and related functions """
    def __init__(self):
        self.txKey = '00101100101001010' # Key to pair bracket and shock unit
        self.radioDataPin = 25           # Board pin for radio DATA line
        self.transmitting = False        # Keep track of whether or not we're sending data
    ...
    def transmit(self, waveID, txTime=1):
        ...
        """
        if self.transmitting:        # If we're already transmitting a punishment
            pass                # Do nothing
        else:                   # Otherwise
            self.transmitting = True # Keep track of transmitting
            ...
            gpio.write(self.radioDataPin, 0)    # Clear data from pin
